...
Following the steps we took in the [Django URLs, Views, and Templates lesson](https://git.generalassemb.ly/SEI-CC/SEIR-09-13-21/blob/main/work/w07/d5/02-03-django-urls-views-templates/django-urls-views-templates.md), complete the following exercises:
