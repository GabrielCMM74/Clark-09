...
# Welcome to General Assembly SEIR-09-13-21!!!!!!
...
- Course Dates: Monday, September 13th, 2021 - Thursday, December 9th, 2021 (60 days)
- Holidays:
...
[Link to join the class Zoom Room](https://generalassembly.zoom.us/j/97752538652?pwd=dGRXbnNVSFBSNEIzVVcwbHl3RHpnQT09)
...
If you have not already done so, please click the link and select Join Room.  Your instructor will provide you with the invite code.
...
2. In another tab, browse to the GA class repo:  [https://git.generalassemb.ly/SEI-CC/SEIR-09-13-21](https://git.generalassemb.ly/SEI-CC/SEIR-09-13-21)
...
```
$ git clone https://git.generalassemb.ly/YOUR-ENTERPRISE-GITHUB-USERNAME/SEI-CC/SEIR-09-13-21
```

You can now `$ cd SEIR-09-13-21` and check out your local copy of of the GA class repo!
...
```
$ git remote add upstream https://git.generalassemb.ly/SEI-CC/SEIR-09-13-21.git
```
